...
public class LocalDiscussionCreationTests extends TestBase {

    @Test
    public void testLocalDiscussionCreation() throws Exception {
        ...
        app.getLocalDiscussionHelper().fillLocalDiscussionForm(new LocalDiscussionData("Тестовое обсуждение (комментирование)", "Описание тестового обсуждения (комментирование)", "Ярославская область", "Ярославль", date_start,date_end, "Приложение ", "Описание приложения", attachment_document));
