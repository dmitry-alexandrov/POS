...
public class LocalPollCreationTests extends TestBase {
  ...
  public void testLocalPollCreation() throws Exception {
    ...
    app.getLocalPollHelper().fillLocalPollForm(new LocalPollData("Тестовое обсуждение (опрос)", "Описание описание тестового обсуждения (опрос)", "Ярославская область", "Ярославль", date_start, date_end, "Да", "Приложение", "Описание приложения", attachment_document_1, "Выбор варианта ответа", "Тестовый вопрос", "1", "Тестовый вариант ответа"));
